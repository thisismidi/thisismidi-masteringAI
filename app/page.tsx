...
export default function Home() {
  ...
  const runMastering = async () => {
    ...
    } catch (error) { alert("엔진 응답 없음") } finally { setIsProcessing(false) }
  }
      ...
      <div className="container" style={{maxWidth:'1200px', margin:'0 auto', padding:'20px'}}>
        ...
        {user ? (
          <div className="dash" style={{display:'flex', flexDirection:'column', gap:'20px'}}>
            <section className="panel track-queue">
              ...
              <ul className="file-list" style={{listStyle:'none', padding:0, margin:'15px 0'}}>
                {files.map((f, i) => (
                  <li key={i} className={activeIndex === i ? 'active' : ''} onClick={() => setActiveIndex(i)} style={{padding:'12px', borderRadius:'8px', cursor:'pointer', display:'flex', justifyContent:'space-between', marginBottom:'5px', background: activeIndex === i ? 'rgba(74,222,128,0.1)' : 'transparent', border: activeIndex === i ? '1px solid var(--acc)' : '1px solid transparent'}}>
            ...
            <div className="main-grid" style={{display:'grid', gridTemplateColumns:'1fr 320px', gap:'20px'}}>
              <div className="monitors">
                <div className="panel monitor-card" style={{marginBottom:'20px'}}>
                  <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'15px'}}>
                    ...
                    }} className="play-btn" style={{background:'var(--txt)', color:'var(--bg)', border:'none', padding:'7px 14px', borderRadius:'7px', fontWeight:'bold', cursor:'pointer'}}>PLAY</button>
                  </div>
                ...
                <div className="panel monitor-card">
                  <div style={{display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:'15px'}}>
                    ...
                    <div style={{display:'flex', gap:'8px'}}>
                      ...
                      }} className="play-btn" disabled={!masteredUrls[activeIndex]} style={{background:'var(--txt)', color:'var(--bg)', border:'none', padding:'7px 14px', borderRadius:'7px', fontWeight:'bold', cursor:'pointer'}}>PLAY</button>
              ...
              <aside className="controls">
                ...
                <div className="panel">
                  ...
                  <div style={{marginBottom:'15px'}}>
                    <div style={{display:'flex', justifyContent:'space-between', fontSize:'0.75rem', marginBottom:'8px'}}><label>True Peak</label><span>{truePeak} dB</span></div>
